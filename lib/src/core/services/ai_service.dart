...
5. "favorite" - добавление или удаление рецепта из избранного.
   - Если пользователь говорит "добавь этот рецепт", "в избранное", "удалить этот рецепт из избранного" (находясь на странице рецепта), используй параметр: current.
...
6. "help" - запрос списка команд (что ты умеешь?, список действий, помощь, инструкция).
